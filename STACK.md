...
*Crates:* `jis-core`, `tibet-cortex-*` (canonical) ↔ `cortex-*` (alias, yank pending).
...
| [`ipoll`](https://pypi.org/project/ipoll/) | 0.2.1 | — | AI-to-AI messaging |

## 4. Continuity & Arrival

| Package | Versie | Tests | Rol |
|---|---|---|---|
| [`tibet-continuityd`](https://pypi.org/project/tibet-continuityd/) | **0.6.14** 🆕 | ✓ | **resident trust/arrival-daemon — month-anchor, central** |
